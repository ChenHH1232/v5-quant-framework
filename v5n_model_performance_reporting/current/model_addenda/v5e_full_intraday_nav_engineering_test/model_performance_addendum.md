...
- Canonical model: `v5e_full_intraday_nav_engineering_test`
...
Return source: `v5e_full_intraday_nav_engineering_test\current\runs\v57f_repaired_baseline\daily_returns.csv`.
