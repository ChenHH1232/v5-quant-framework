...
- Canonical model: `v5f_locked_pool_conditional_momentum`
...
Return source: `v5f_locked_pool_conditional_momentum\current\v5f_locked_pool_conditional_momentum_daily_returns.csv`.
