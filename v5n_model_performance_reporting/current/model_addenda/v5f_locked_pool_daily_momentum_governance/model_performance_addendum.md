...
- Canonical model: `v5f_locked_pool_daily_momentum_governance`
...
Return source: `v5f_locked_pool_daily_momentum_governance\current\v5f_locked_pool_daily_momentum_daily_returns.csv`.
