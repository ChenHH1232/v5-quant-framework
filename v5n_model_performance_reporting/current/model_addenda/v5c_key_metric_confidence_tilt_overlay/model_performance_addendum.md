...
- Canonical model: `v5c_key_metric_confidence_tilt_overlay`
...
Return source: `v5c_key_metric_confidence_tilt_overlay\current\v5c_key_metric_confidence_tilt_daily_returns.csv`.
