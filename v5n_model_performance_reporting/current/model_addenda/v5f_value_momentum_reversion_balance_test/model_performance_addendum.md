...
- Canonical model: `v5f_value_momentum_reversion_balance_test`
...
Return source: `v5f_value_momentum_reversion_balance_test\current\v5f_vmr_balance_daily_returns.csv`.
