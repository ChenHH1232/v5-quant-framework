...
# Compatibility implementation moved behind the public facade in
# coal_data_audit_runner.py while the coal audit internals are split.
...
from v5.math_utils import fmt_float, nearest_quantile, ratio, safe_median, to_float
from v5.paths import DEFAULT_DATABASE_DIR as SHARED_DATABASE_DIR
from v5.paths import DEFAULT_MANIFEST_DIR as SHARED_MANIFEST_DIR
from v5.paths import DEFAULT_PROCESSED_DIR as SHARED_PROCESSED_DIR
...
DEFAULT_DATABASE_DIR = SHARED_DATABASE_DIR
DEFAULT_PROCESSED_DIR = SHARED_PROCESSED_DIR
DEFAULT_MANIFEST_DIR = SHARED_MANIFEST_DIR
