...
- Canonical model: `v5f_event_triggered_mean_reversion_borrowing_test`
...
Return source: `v5f_event_triggered_mean_reversion_borrowing_test\current\v5f_mr_borrowing_daily_returns.csv`.
