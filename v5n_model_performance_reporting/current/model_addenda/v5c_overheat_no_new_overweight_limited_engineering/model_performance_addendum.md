...
- Canonical model: `v5c_overheat_no_new_overweight_limited_engineering`
...
Return source: `v5c_overheat_no_new_overweight_limited_engineering\current\v5c_overheat_no_new_overweight_daily_returns.csv`.
