...
- Canonical model: `v5f_momentum_weight_tilt_limited_engineering`
...
Return source: `v5f_momentum_weight_tilt_limited_engineering\current\v5f_momentum_weight_tilt_daily_returns.csv`.
