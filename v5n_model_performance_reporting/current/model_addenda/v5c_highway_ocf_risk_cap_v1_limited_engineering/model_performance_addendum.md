...
- Canonical model: `v5c_highway_ocf_risk_cap_v1_limited_engineering`
...
Return source: `v5c_highway_ocf_risk_cap_v1_limited_engineering\current\v5c_highway_ocf_risk_cap_daily_returns.csv`.
