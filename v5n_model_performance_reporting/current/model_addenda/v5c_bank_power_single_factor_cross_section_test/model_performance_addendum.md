...
- Canonical model: `v5c_bank_power_single_factor_cross_section_test`
...
Return source: `v5c_bank_power_single_factor_cross_section_test\current\v5c_bank_power_single_factor_daily_returns.csv`.
