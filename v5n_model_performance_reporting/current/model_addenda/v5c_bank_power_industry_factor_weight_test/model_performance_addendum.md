...
- Canonical model: `v5c_bank_power_industry_factor_weight_test`
...
Return source: `v5c_bank_power_industry_factor_weight_test\current\v5c_bank_power_industry_factor_daily_returns.csv`.
