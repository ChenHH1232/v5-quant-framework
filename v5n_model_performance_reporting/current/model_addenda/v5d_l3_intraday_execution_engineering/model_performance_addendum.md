...
- Canonical model: `v5d_l3_intraday_execution_engineering`
...
| Metric | Value |
|---|---:|
| total_return_pct | 79.30336791500012 |
| annualized_return_pct | 13.973480836256535 |
| max_drawdown_pct | 11.679482725028478 |
| annualized_volatility_pct | 15.663837891118792 |
| sharpe_ratio | 0.913676823685176 |
| observations | 1125 |
...
| excess_return_pct_points | 28.29148885324082 |
| annualized_excess_return_pct | 3.513568884558834 |
| max_drawdown_delta_pct_points | -6.191805199375999 |
| volatility_ratio | 0.8880897660577551 |
| tracking_error_pct | 8.474412595636629 |
| information_ratio | 0.41460913602058136 |
| beta_zero_rf | 0.778924935073804 |
| alpha_zero_rf_annualized_pct | 5.900763249797468 |
| benchmark_sharpe_ratio | 0.6122188610288551 |

Return source: `v5d_l3_intraday_execution_engineering\current\runs\v57f_frozen\l3_default_exception\daily_returns.csv`.
