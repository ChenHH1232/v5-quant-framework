...
- Canonical model: `v5e_daily_momentum_diagnostic_addendum`
...
Return source: `v5e_daily_momentum_diagnostic_addendum\current\v5e_daily_momentum_nav_proxy_comparison.csv`.
