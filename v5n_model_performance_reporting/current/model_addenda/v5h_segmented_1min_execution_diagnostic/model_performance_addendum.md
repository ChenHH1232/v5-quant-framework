...
- Canonical model: `v5h_segmented_1min_execution_diagnostic`
...
Return source: `v5h_segmented_1min_execution_diagnostic\current\v5h_segmented_execution_daily_nav.csv`.
