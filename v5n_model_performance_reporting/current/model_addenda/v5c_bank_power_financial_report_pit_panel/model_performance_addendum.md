...
- Canonical model: `v5c_bank_power_financial_report_pit_panel`
...
Return source: `v5c_bank_power_financial_report_pit_panel\current\v5c_bank_power_financial_report_factor_daily_returns.csv`.
